...
export default function JoinUsList({token}: {token: string}) {
    ...
    return (
        <div>
            ...
            <section className="flex flex-col w-full items-center text-[#808080]">
                ...
                <h2 className="hidden md:block mx-[348px] mt-[54px] mb-[150px] font-bold text-center md:mb-[50px] md:mx-[150px] leading-tight">
